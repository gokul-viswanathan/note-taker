    ...
    fetch(`${backendURL}/v1/oauth/callback`, {
      ...
      .then(async (res) => {
        if (res.ok) {
          ...
          setStatus(
            errorData.message ||
              "Error completing authorization. Please try again.",
          );
          setStatusType("error");
        }
      })
  ...
  return (
    ...
    >
      <div className="min-h-screen flex items-center justify-center p-4">
        <div
          className={`max-w-md w-full p-8 rounded-3xl transition-all duration-500 ${
            darkMode
        ...
        >
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p
                    className={`text-xs mt-1 ${darkMode ? "text-green-300" : "text-green-600"}`}
                  >
          ...
          {statusType === "error" && (
            <div className="space-y-3">
              <button
                onClick={handleRetry}
                className={`w-full py-3 px-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center justify-center space-x-2 ${
                  darkMode
