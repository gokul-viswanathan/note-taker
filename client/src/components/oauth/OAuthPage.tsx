...
import { Github, FileText, GitBranch, Shield, Moon, Sun, Sparkles } from 'lucide-react';
...
const GitHubAuthPage = () => {
    ...
    return (
        <div className={`min-h-screen transition-all duration-500 ${darkMode
            ...
            <button
                onClick={toggleTheme}
                className={`fixed top-6 right-6 p-3 rounded-full transition-all duration-300 hover:scale-110 z-10 ${darkMode
                ...
                <div className="max-w-4xl w-full grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <h2 className={`text-3xl lg:text-4xl font-bold leading-tight ${darkMode ? 'text-white' : 'text-gray-900'
                                }`}>
                            ...
                            <p className={`text-lg ${darkMode ? 'text-gray-300' : 'text-gray-600'
                                ...
                                Connect with GitHub to unlock powerful features and keep your notes synchronized across all your devices.
                            </p>
                        </div>
                    ...
                    <div className="flex justify-center lg:justify-end">
                        <div className={`w-full max-w-md p-8 rounded-3xl transition-all duration-500 ${darkMode
                            ...
                            <button
                                ...
                                disabled={isLoading}
                                className={`w-full py-4 px-6 rounded-xl font-semibold text-white transition-all duration-300 transform hover:scale-105 active:scale-95 disabled:scale-100 disabled:opacity-70 flex items-center justify-center space-x-3 ${darkMode
                            ...
                            {/* Security Note */}
                            <div className={`mt-6 p-4 rounded-xl ${darkMode
                                ? 'bg-gray-700/30 border border-gray-600/30'
                                : 'bg-gray-50/70 border border-gray-200/50'
                                }`}>
                                <div className="flex items-start space-x-3">
                                    <Shield className={`w-5 h-5 mt-0.5 ${darkMode ? 'text-green-400' : 'text-green-600'
                                        }`} />
                                    <div>
                                        ...
                                        <p className={`text-xs mt-1 ${darkMode ? 'text-gray-400' : 'text-gray-600'
                                            ...
                                            We only request minimal permissions needed to sync your notes. Your data stays private and secure.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <p className={`text-center text-xs mt-6 ${darkMode ? 'text-gray-500' : 'text-gray-500'
                                ...
                                <a href="#" className={`underline hover:no-underline ${darkMode ? 'text-purple-400' : 'text-blue-600'
                                    }`}>
                                    Terms of Service
                                </a>{' '}
                                and{' '}
