...
const FolderTree: React.FC<FolderTreeProps> = ({
  ...
  useEffect(() => {
    console.log("Creation mode changed within newfoldertree:", {
      isCreateFolderOpen,
      isCreateFileOpen,
    });
        ...
        contextMenuItem?.type != "dir" && (
          <div className="flex items-center p-2 mb-2 bg-gray-50 dark:bg-gray-800 rounded-md">
            ...
            <Input
              ...
              placeholder={
                isCreateFolderOpen ? "New folder name" : "New file name"
              }
            />
            <div className="flex items-center ml-2 gap-1">
              <button
                onClick={
                  isCreateFolderOpen ? handleCreateFolder : handleCreateFile
                }
        ...
        <div key={`${item.path}-${index}`}>
          {item.type === "dir" ? (
            <>
              ...
              {(isCreateFolderOpen || isCreateFileOpen) &&
                item.path === currentCreateFolderPath && (
